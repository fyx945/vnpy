...
启动登录AI智能量化软件 Elite Trader后，启动模块之前，请先连接交易接口。看到AI智能量化软件 Trader主界面【日志】栏输出“合约信息查询成功”之后再启动模块。
...
发出委托后，除了可在图表的【委托】列观察到委托数量之外，还可在AI智能量化软件 Elite Trader主界面【委托】组件和【成交】组件上跟踪到根据对应接口下单的委托，如下图所示：
