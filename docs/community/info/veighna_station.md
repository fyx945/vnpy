...
安装成功后，双击桌面上AI智能量化软件 Station快捷方式：

![](https://vnpy-doc.oss-cn-shanghai.aliyuncs.com/veighna_station/1.png)

即可运行AI智能量化软件 Station。

### 命令行启动

打开命令行工具，输入veighna回车运行，即可启动AI智能量化软件 Station。

## 用户登录

首次使用AI智能量化软件 Station时会弹出AI智能量化软件 Studio的免责声明，如下图所示：
...
用户按照要求在用户名输入框中输入用户名，在密码输入框中输入密码后，点击【登录】按钮，即可完成登录进入AI智能量化软件 Station主运行程序。

新用户可以点击【注册】按钮注册账户，注册完成后即可登录。注册时请注意:

- 个人邮箱请如实填写（后续用于找回密码等论坛功能）；
- 用户名自动使用注册时的微信【昵称】（不支持修改）；
- 密码请牢记，该密码也同样用于登录AI智能量化软件社区论坛。

**登录界面只在首次运行AI智能量化软件 Station时弹出**，之后运行AI智能量化软件 Station时会自动登录。

## 界面窗口

登录完成后，AI智能量化软件 Station界面会自动弹出，如下图所示：
...
PyPI索引用于更换AI智能量化软件 Station使用的pypiserver地址，当留空时默认使用的是https://pypi.org的PyPI服务器。
...
如上图所示，AI智能量化软件 Station界面左下角为学习与使用区域。

点击【使用文档】后会打开浏览器，并跳转到官方文档https://it.zhengyee.com/docs/cn/index.html ，用户可以查询详细的使用说明。

点击【社区求助】后会打开浏览器，并跳转到官方论坛https://it.zhengyee.com/forum/ ，用户可以在论坛查询技术贴，并发帖交流。
...
点击AI智能量化软件 Station左侧的【社区】按钮，右侧主显示区域显示内容为官方论坛，如下图所示：
...
点击AI智能量化软件 Station左侧的【交易】按钮，右侧主显示区域显示内容为交易接口、应用模块选择区域和信息输出区域，如下图所示：

![](https://vnpy-doc.oss-cn-shanghai.aliyuncs.com/veighna_station/12.png)

点击需要加载的交易接口或应用模块后的白色复选框，进行选择。然后点击主显示区域左下角【启动】按钮，即可启动AI智能量化软件 Trader。此时，右侧输出区域将输出程序运行中的信息，如下图所示：
...
点击AI智能量化软件 Station左侧的【投研】按钮，右侧主显示区域为jupyterlab应用操作目录，如下图所示：
...
点击AI智能量化软件 Station左侧的【加密】按钮，右侧主显示区域显示加密相关内容，如下图所示：
...
点击AI智能量化软件 Station左侧的【更新】按钮，右侧主显示区域显示组件更新相关内容，如下图所示：
...
更新完成后，会弹出通知窗口，点击【OK】并重启AI智能量化软件 Station即可。
