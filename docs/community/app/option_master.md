...
启动登录AI智能量化软件 Station后，点击【交易】按钮，在配置对话框中的【应用模块】栏勾选【OptionMaster】。
...
启动AI智能量化软件 Trader后，在菜单栏中点击【功能】-> 【期权交易】，或者点击左侧按钮栏的图标：
...
整体使用方法和AI智能量化软件 Trader主界面的交易组件相似，输入合约代码、买卖方向、开平方向、交易价格和数量后，点击【委托】按钮即可发出限价委托，点击【全撤】按钮即可一键全撤当前的全部活动委托。
